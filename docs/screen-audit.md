...
| Account/Security | partial                   | real session/device management, preferences, TOTP, one-time recovery codes, and feature-flagged Google/Microsoft OAuth login; WebAuthn shown as unavailable  | real WebAuthn/Passkeys implementation                                                                   |
